...
import { PartesIniciasType } from "@/types/TypeDesiganationView";

export function PartesIniciasView({
  Date: PartesIniciasData,
}: {
  Date: PartesIniciasType[];
}) {
  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <div className={"grid gap-3"}>
        {PartesIniciasData &&
        PartesIniciasData.length > 0 ? (
          PartesIniciasData.map((des) => {
