...
import { CristaoValueType } from "@/app/main/(dashboard)/components/CardsDesignations/LifeMinistry/Cristaos";
...
export function RemoverDesignacao({
  ...
  const { data, error, isLoading, mutate } = useFetch<RegistoCristao[]>(
    `cristao/${id}`
  );
