...
import {ImprovedReaderWatchTower} from "@/store/Teste de componenete"
export default function Page() {
  return (
    <div className="min-h-screen dark:bg-[var(--background)] text-white bg-white">
      <ImprovedReaderWatchTower></ImprovedReaderWatchTower>
      <div className="grid lg:grid-cols-[280px_1fr] hidden">
