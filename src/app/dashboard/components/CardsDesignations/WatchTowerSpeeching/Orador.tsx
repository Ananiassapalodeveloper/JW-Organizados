"use client"
import { BookHeart, Check, ChevronsUpDown, MagnetIcon, User } from "lucide-react"
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex flex-col">
          <span className="text-lg ">Orador</span>
          <span className="flex items-center gap-2 text-xs"><BookHeart size={14} /> Tema: COMO SER DIFERENTE DO MUNDO?</span>
        </CardTitle>
        <CardDescription>
