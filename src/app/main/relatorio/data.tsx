...
import { Members } from "../membros/data/data"
...
//     text: "I have an informal announcement to make during our team meeting. It pertains to a strategic shift in our approach to the upcoming product launch. We've received valuable feedback from our beta testers, and I believe it's time to make some adjustments to better meet our customers' needs.\n\nThis change is crucial to our success, and I look forward to discussing it with the team. Please be prepared to share your insights during the meeting.\n\nRegards, Michael",
...
export const mails=[...Members]

export type Mail = (typeof  Members)[number]

export const accounts = [
  {
    label: "Grupo nº 1",
    email: "Ernesto Nhanga",
    icon: <User2 color="red"/>
  },
  {
    label: "Grupo nº 2",
    email: "André Vinho",
  ...
  {
    label: "Grupo nº 3",
    email: "Valention Kiluluta",
    icon: <User2 color="green"/>
    ,
  },
]
