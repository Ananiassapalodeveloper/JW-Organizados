    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex flex-col">
          <span className="text-lg ">Leitura da Bíblia </span>
          <span  className="flex items-center gap-2 text-xs"><Clock10Icon size={14}/> 4 min ou menos</span>
        </CardTitle>
        <CardDescription>
