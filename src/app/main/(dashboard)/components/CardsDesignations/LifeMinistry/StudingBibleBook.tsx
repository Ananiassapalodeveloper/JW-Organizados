"use client"
import {  Check, ChevronsUpDown, Clock10Icon, MagnetIcon, User } from "lucide-react"
...
export function StudingBibleBook() {
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex flex-col">
          <span className="text-lg ">Estudo bíblico de congregação</span>
          <span className="flex items-center gap-2 text-xs"><Clock10Icon size={14} /> 30 min</span>
        </CardTitle>
        <CardDescription>
