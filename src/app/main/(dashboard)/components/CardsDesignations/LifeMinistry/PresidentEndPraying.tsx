"use client"
import { AlertCircle, Check, ChevronsUpDown, MagnetIcon } from "lucide-react"
...
export function PresidentEndPraying() {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle  className="flex items-center">Presidente & oração inicial</CardTitle>
        <CardDescription>
