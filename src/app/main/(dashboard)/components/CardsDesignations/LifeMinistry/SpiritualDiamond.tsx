...
export function SpirutalDiamond() {
  ...
  return (
    <Card className="w-full">
      ...
      <CardTitle className="flex flex-col">
          <span className="text-lg ">Pérolas Espirituais</span>
          <span  className="flex items-center gap-2 text-xs"><Clock10Icon size={14}/> 10 min</span>
        </CardTitle>
        <CardDescription>
