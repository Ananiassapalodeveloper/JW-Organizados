...
import { RemoverDesignacaoDialog } from "@/components/RemoverReuniaoPublica/removedor-designacao-dialog";
import {
  reuniaoPublicaSchema,
  type reuniaoPublicaType,
} from "@/types/reuniaoFimSemanaDTO/type";
import { Input } from "@/components/ui/input";
import { mutate } from "swr";
const defaultValues: Partial<reuniaoPublicaType> = {
  name: "presidente",
  ReunioesDatesId: "",
  tema: "",
  memberId: "",
...
export const ReuniaoPublicaValueType = [
  { value: "presidente", name: "Presidente" },
  { value: "oracaoInicial", name: "Oração Inicial" },
  { value: "orador", name: "Orador" },
];

export function ReuniaoPublica({ params }: { params: { id: string } }) {
  ...
  const form = useForm<reuniaoPublicaType>({
    resolver: zodResolver(reuniaoPublicaSchema),
    defaultValues: {
      ...defaultValues,
  ...
  async function onSubmit(values: reuniaoPublicaType) {
    try {
      setSubmitError(null);
      ...
      await api.post("reuniaoPublica", formData);
      toast({
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <SelectTrigger id="nome" className="border-0 text-lg p-0">
                          <SelectValue placeholder="nome" className="p-0" />
                        </SelectTrigger>
                        <SelectContent>
                          {ReuniaoPublicaValueType.map((data) => (
              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-medium">Irmão designado</h3>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          <FormLabel>Selecione um irmão </FormLabel>
                          <Popover>
                  ...
                  <div className="space-y-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          <FormLabel>Selecione um irmão suplente</FormLabel>
                          <Popover>
                            <PopoverTrigger asChild>
                              <FormControl>
                                <Button
