/*
  ...
  - You are about to drop the column `lesson` on the `Tesouros` table. All the data in the column will be lost.
...
INSERT INTO "new_Tesouros" ("ReunioesDatesId", "id", "memberId", "name", "nameLivro", "suplenteMemberId") SELECT "ReunioesDatesId", "id", "memberId", "name", "nameLivro", "suplenteMemberId" FROM "Tesouros";
DROP TABLE "Tesouros";
